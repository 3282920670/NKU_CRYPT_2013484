...
本文以C++语言，对古典密码算法里面的移位密码和单表置换密码进行了加解密和破解程序的讲解\\


\textbf{关键词:}  C++，古典密码，移位密码，单表置换加密，字母频率统计攻击
...
{\tiny %This paper takes the process of GCC compiler compiling C language program under Linux environment as an example, combining literature and experimental results, analyzes the main work flow of the compiler, and analyzes the annotation of LLVM IR programming program.\\
